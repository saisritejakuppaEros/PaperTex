...
\begin{equation}
  \mathcal{L}_{\text{FM}} = \mathbb{E}_{t,\, z_0,\, z_1} \left[ \left\lVert v_\theta\bigl(z_t, t, \mathbf{p}, z_{\mathcal{C}}, z_{D_s}; \AdaptW\bigr) - (z_1 - z_0) \right\rVert_2^2 \right],
\end{equation}
