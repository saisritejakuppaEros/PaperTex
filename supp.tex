...
Reference images are drawn from diverse, in-the-wild sources rather than our private movie dataset, which is intentionally skewed toward Indic cultural elements; for this generic counterpart, face portraits are sampled from the Celebrity-1000 dataset~\cite{tonyassi2024celebrity1000}, while landmark and object references are sampled from the culturally diverse image collection introduced by Kannen et al.~\cite{kannen2024beyond}, giving broader geographic and cultural coverage than the private movie dataset alone.
